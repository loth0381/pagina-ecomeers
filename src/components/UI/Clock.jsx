...
const Clock = () => {
  ...
  return (
    <div className='clock__wrapper d-flex align-items-center gap-3'>
        <div className='clock__data d-flex align-items-center gap-3'>        {/*quita parte del home*/}
        ...
        <div className='clock__data d-flex align-items-center gap-3'>        {/*quita parte del home hora de tiempo de oferta*/}
        <div className='text-center'>
